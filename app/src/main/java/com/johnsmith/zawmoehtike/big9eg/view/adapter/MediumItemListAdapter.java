 ...
 */
public class MediumItemListAdapter extends RecyclerView.Adapter<MediumItemListAdapter.MyViewHolder> {

    private Context mContext;
    private List<Item> itemList;

    public MediumItemListAdapter(Context mContext, List<Item> itemList) {
